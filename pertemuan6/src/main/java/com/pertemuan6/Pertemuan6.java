...
public class Pertemuan6 {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Pertama-tama, jika kita memsukkan nilai 85-100, maka akan mendapatkan grade A (dengan menggunakan if).
         * Lalu jika kita memasukkan nilainya dibawah 85, maka kita akan mendapatkan grade B dan C (else if),
           atau mungkin kita akan dinyatakan tidak lulus jika dubawah 65 (else).
